  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="home-info mr-auto">
       <i class="icofont-home"></i>Agrotrends Digital Platform
      </div>
      <div class="help">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              ...
              <div class="member-info">
                <h4>YEKEEN GANIU</h4>
                <span>Administrative &amp; Operations Director</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              ...
              <div class="member-info">
                <h4>ALABI STEPHEN</h4>
                <span>Investment &amp; Strategy Advisor</span>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="social-links mt-3">
              ...
              <a href="https://instagram.com/agrotrending" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
            </div>
          </div>
